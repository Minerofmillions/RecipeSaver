...
{
    [UsedImplicitly]
    public readonly IDictionary<int, IDictionary<string, float>> globalLoot =
        new SortedDictionary<int, IDictionary<string, float>>();

    [UsedImplicitly]
    public readonly IDictionary<int, IDictionary<string, float>> normalLoot =
        new SortedDictionary<int, IDictionary<string, float>>();

    [UsedImplicitly]
    public readonly IDictionary<int, IDictionary<string, float>> expertLoot =
        new SortedDictionary<int, IDictionary<string, float>>();

    [UsedImplicitly]
    public readonly IDictionary<int, IDictionary<string, float>> masterLoot =
        new SortedDictionary<int, IDictionary<string, float>>();
    ...
    private static void AddItemToDict(IDictionary<int, IDictionary<string, float>> dict, string condition, int itemId,
        int numerator, int denominator, int min, int max, float inheritedChance = 1f) =>
    ...
    private void AddRule(IItemDropRule rule, IDictionary<int, IDictionary<string, float>> dict, float inheritedChance,
        string condition)
    {
        ...
        switch (rule)
        {
            case CommonDropWithRerolls c:
                AddItemToDict(dict, condition, c.itemId,
                    inheritedChance *
                    (1 - MathF.Pow(1 - (float)c.chanceNumerator / c.chanceDenominator, c.timesToRoll)),
                    c.amountDroppedMinimum, c.amountDroppedMaximum);
            ...
            case ItemDropWithConditionRule i:
                ...
                AddItemToDict(dict, newCondition, i.itemId, i.chanceNumerator, i.chanceDenominator,
                    i.amountDroppedMinimum, i.amountDroppedMaximum, inheritedChance);
            ...
            case OneFromOptionsDropRule o:
                ...
                {
                    AddItemToDict(dict, condition, dropId, o.chanceNumerator, o.chanceDenominator * o.dropIds.Length, 1,
                        1, inheritedChance);
                }
            ...
            case OneFromRulesRule o:
                ...
                {
                    AddRule(r, dict, inheritedChance * o.chanceNumerator / (o.chanceDenominator * o.options.Length),
                        condition);
                }
            ...
            case FewFromOptionsDropRule f:
                ...
                {
                    AddItemToDict(dict, condition, dropId, f.chanceNumerator * f.amount,
                        f.chanceDenominator * f.dropIds.Length, 1, 1, inheritedChance);
                }
            ...
            case LeadingConditionRule l:
                ...
                break;
            case DropOneByOne o:
                AddItemToDict(dict, condition, o.itemId, o.parameters.ChanceNumerator, o.parameters.ChanceDenominator,
                    o.parameters.MinimumItemDropsCount, o.parameters.MaximumItemDropsCount, inheritedChance);
                o.ChainedRules.ForEach(r => AddRule(r.RuleToChain, dict, inheritedChance, condition));
                break;
            ...
            case CoinsRule c:
                ...
                if (value % 100 != 0L)
                {
                    AddItemToDict(dict, condition, ItemID.CopperCoin, inheritedChance, (int)value % 100,
                        (int)value % 100);
                }
                ...
                if (value % 100 != 0L)
                {
                    AddItemToDict(dict, condition, ItemID.SilverCoin, inheritedChance, (int)value % 100,
                        (int)value % 100);
                }
                ...
                if (value % 100 != 0L)
                {
                    AddItemToDict(dict, condition, ItemID.GoldCoin, inheritedChance, (int)value % 100,
                        (int)value % 100);
                }
                ...
                if (value > 0L)
                {
                    AddItemToDict(dict, condition, ItemID.PlatinumCoin, inheritedChance, (int)value, (int)value);
                }

                c.ChainedRules.ForEach(r => AddRule(r.RuleToChain, dict, inheritedChance, condition));
                break;
            case CommonDrop c:
                AddItemToDict(dict, condition, c.itemId, c.chanceNumerator, c.chanceDenominator, c.amountDroppedMinimum,
                    c.amountDroppedMaximum, inheritedChance);
                c.ChainedRules.ForEach(r => AddRule(r.RuleToChain, dict, inheritedChance, condition));
                break;
        }
    }
    ...
    public class LootConverter : JsonConverter<JsonLoot>
    {
        ...
        public override JsonLoot ReadJson(JsonReader reader, Type objectType, JsonLoot existingValue,
