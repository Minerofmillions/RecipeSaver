...
public readonly struct NPCSpawnShimmerResult(int npcResult) : IShimmerResult
{
...
public readonly struct DecraftShimmerResult(int decraftingRecipeIndex) : IShimmerResult
{
